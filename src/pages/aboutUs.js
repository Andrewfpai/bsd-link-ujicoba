...
function AboutUs() {
  ...
  return (
    <div className='bg-yellow h-full  container mx-auto '>
      ...
      <Navbar className='z-50' sendDataToHome={sendDataToHome}/>
        ...
        <div className="bottomter flex-1 bg-lychee">
          <div className="mt-10 pb-12 text-4xl font-semibold text-left leading-tight z-0 ml-9">ABOUT US.</div>
          ...
          <div className=' flex flex-row gap-5 text-center px-10'>
            <section class="w-36 mb-10 mx-auto bg-[#20354b] rounded-2xl px-8 py-6 shadow-lg">
          
              <div class="mt-3 w-fit mx-auto">
                  <img src={Pai} class="rounded-[50%] w-16 h-16 object-cover" alt="profile"/>
              </div>

              <div class="mt-5 ">
                  <h2 class="text-lychee font-semibold text-16 tracking-wide">Nicolas Andrew</h2>
              </div>
              <p class="text-gray-500 mt-2.5 text-12" >
                  Web Developer
              </p>
            </section>
            <section class="w-36 mb-10 mx-auto bg-[#20354b] rounded-2xl px-8 py-6 shadow-lg">
              ...
              <div class="mt-3 w-fit mx-auto">
                  <img src={Opin} class="rounded-[50%] w-16 h-16 object-cover" alt="profile"/>
              </div>

              <div class="mt-5 ">
                  <h2 class="text-lychee font-semibold text-16 tracking-wide">Josefine Celka</h2>
              </div>
              <p class="text-gray-500 mt-2.5 text-12" >
                  UI/UX Designer
              </p>
